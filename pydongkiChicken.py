...
folder_path = "dongkiChicken"
filename = f"{folder_path}/dongkiChicken_{current_date}.json"
...
# URL 정의 및 데이터 추출
url = "https://m.booking.naver.com/order/bizes/513802/items/3888441?theme=place&refererCode=menutab&area=ple"
