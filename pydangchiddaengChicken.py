...
folder_path = "dangchiddaengChicken"
filename = f"{folder_path}/dangchiddaengChicken_{current_date}.json"
...
# URL 정의 및 데이터 추출
url = "https://m.booking.naver.com/order/bizes/958145/items/5240084?theme=place&entry=pll&area=pll"
